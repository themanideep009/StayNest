...
async function sendPasswordResetEmail({ to, code }) {
    ...
    await transporter.sendMail({
        ...
        text: `Your StayNest password reset verification code is ${code}. This code will expire in 15 minutes.`,
        html: `
            <div style="font-family:Arial,sans-serif;line-height:1.6;color:#2f2419;max-width:560px;margin:0 auto;">
                ...
                <p>We received a request to reset your StayNest account password.</p>
                ...
                <p style="margin-top:24px;color:#7d6652;">StayNest Security Team</p>
            </div>
        `,
    });
}
